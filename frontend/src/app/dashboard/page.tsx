    ...
    <div className="card-premium p-5 sm:p-6">
      ...
      {expanded && (
        <div className="space-y-4 mb-4 animate-fade-in">
          {/* Contact */}
          {pf.contact && (pf.contact.email || pf.contact.phone || pf.contact.linkedin || pf.contact.website) && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 text-sm text-slate-600">
                ...
                {pf.contact.linkedin && (
                  <div className="flex items-center gap-2">
                    ...
                    <a href={pf.contact.linkedin} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline truncate">
                      LinkedIn
                    </a>
                  </div>
                )}
                {pf.contact.website && (
                  <div className="flex items-center gap-2">
                    ...
                    <a href={pf.contact.website} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:underline truncate">
                      {pf.contact.website}
                    </a>
                  </div>
                )}
